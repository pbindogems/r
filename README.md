...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/r)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/r
```

A live public deployment of this template is available at [https://r.templates.workers.dev](https://r.templates.workers.dev)
